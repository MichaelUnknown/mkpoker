...
int main()
{
    ...
    mkp::gamestate<6> game_6pn{10000};
    mkp::gamestate_enumerator<6, uint32_t> enc_6pn{};
    mkp::action_abstraction_fcr<6> aa_6pn{};
    auto gametree_base_6pn = mkp::init_tree(game_6pn, &enc_6pn, &aa_6pn);
